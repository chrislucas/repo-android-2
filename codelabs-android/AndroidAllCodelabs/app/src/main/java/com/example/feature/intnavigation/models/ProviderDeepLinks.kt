...
import com.example.feature.intnavigation.view.rc.action.BindDeeplinkImageAndTextViewHolderLayout

fun providerDeepLinks(context: Context) : List<ViewHolderData<out ViewHolder, Deeplink>> = listOf(
   ...
   ViewHolderData(
      ...
      BindDeeplinkImageAndTextViewHolderLayout(),
      ImageAndTextDeeplinkViewType()
   )
)