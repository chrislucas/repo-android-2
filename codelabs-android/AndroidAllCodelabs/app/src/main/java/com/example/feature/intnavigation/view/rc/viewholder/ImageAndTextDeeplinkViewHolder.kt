...
class ImageAndTextDeeplinkViewHolder(viewGroup: ViewGroup): ViewHolder(viewGroup), MatchViewHolder {

    private val view: View by lazy {
        LayoutInflaterHelper.inflate(viewGroup, R.layout.layout_image_and_text_item_deep_link)
    }

    private val typeViewHolder = ImageAndTextDeeplinkViewType().type

    private val tvTitle: MaterialTextView by lazy { view.findViewById(R.id.tv_title_item_deeplink_1) }
