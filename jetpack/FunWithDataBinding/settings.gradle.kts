...
include(":funwithworkmanager")
include(":funwithcamerax")
include(":appdataandfile")
include(":fileuploadclient")
include(":justconstraintlayoutstudies")
include(":opencamerafromwebview")
include(":funwithcontentprovider")
include(":animationtransition")
include(":funwithnavigationapi")
include(":loginbiometricandroid")
include(":coroutinecodelabs")
include(":funwithktor")
include(":FunWithHilt")
