...
class WebChromeFileChooserClientII(
    ...
    private val intentCaptureImage: IntentCaptureImage
) : WebChromeClient() {
    ...
    private fun createImageCaptureIntent(): Intent? {
        return intentCaptureImage.createIntentCaptureImage()?.run {
            try {
...
class FileUploadWebViewActivity : AppCompatActivity(), IntentCaptureImage {
