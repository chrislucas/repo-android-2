package com.br.kmm.multilanguagesupport.tutorials.google.tutorials.lessoniv
...
fun Conversation(modifier: Modifier = Modifier, messages: List<Message>) {
    LazyColumn(modifier) {
        items(messages) { message ->
            MessageCard(modifier, msg = message)
        }
    }
}

@Preview(showSystemUi = false, uiMode = UI_MODE_NIGHT_YES, showBackground = true)
@Composable
private fun PreviewConversation() {
    MultilanguageSupportTheme {
        Conversation( modifier = Modifier.fillMaxWidth(),
