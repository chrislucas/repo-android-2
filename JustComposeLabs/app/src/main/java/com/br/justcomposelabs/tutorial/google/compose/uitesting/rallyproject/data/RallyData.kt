...
object UserData {
    val accounts =
        listOf(
            Account("Checking", 1234, 2210.65f, Color(0xFF004940)),
            Account("Home Savings", 5678, 8672.88f, Color(0xFF005D57)),
    ...
    val bills =
        listOf(
            ...
            Bill("Rent", "Feb 1", 1275.00f, Color(0xFFFF6951)),
            Bill("TabFine Loans", "Feb 12", 459.23f, Color(0xFFFFD7D0)),
