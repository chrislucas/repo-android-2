package com.br.justcomposelabs.tutorial.google.compose.uitesting.rallyproject.ui.theme
...
fun RallyDialogThemeOverlay(content: @Composable () -> Unit) {
    ...
    val dialogTypography =
        currentTypography.copy(
            bodySmall =
            currentTypography.bodySmall.copy(
            ...
            labelSmall =
            currentTypography.labelSmall.copy(
